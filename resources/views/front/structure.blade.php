...
if (isset($dpdStructures) && is_iterable($dpdStructures)) {
        ...
        <section id="dpd-structure" class="py-16 bg-white full-width fade-in-up">
            <div class="px-4 sm:px-6 lg:px-8 mx-auto">
                <div class="bg-gray-50 rounded-2xl shadow-xl p-8 md:p-12 full-width">
                    ...
                    <!-- Ketua Section (Paling Atas - Terpisah) -->
                    <section class="py-16 bg-gradient-to-b from-white to-gray-50 fade-in-up">
                        <div class="px-4 sm:px-6 lg:px-8 mx-auto max-w-6xl">
                            <div class="text-center mb-12">
                                <h2 class="text-3xl md:text-4xl font-bold text-[#001F3F] mb-4">Ketua</h2>
                                <p class="text-gray-600 max-w-2xl mx-auto">Pimpinan tertinggi Partai NasDem Kabupaten Bojonegoro</p>
                            </div>

                            <!-- Single Ketua Card (Centered) -->
                            <div class="flex justify-center">
                                <div class="max-w-md w-full">
                                    <div class="structure-card">
                                        <div class="structure-image-container">
                                            @if($ketua && $ketua->person_photo)
                                            @php
                                            $photoUrl = getStructurePhotoUrl($ketua->person_photo);
                                            @endphp
                                            ...
                                            <!-- Fallback avatar -->
                                            <div class="structure-avatar" style="{{ ($ketua->person_photo && isset($photoUrl)) ? 'display: none;' : '' }}">
                                        ...
                                        <h3 class="structure-name text-2xl">{{ $ketua->person_name ?? 'Ketua DPC' }}</h3>
                                        <p class="structure-position text-lg font-semibold text-blue-600">
                                            {{ $ketua->position->name ?? 'Ketua DPC' }}
                                        </p>

                                        @if($ketua && ($ketua->external_phone || $ketua->external_email))
                                        <div class="structure-contact">
                                            @if($ketua->external_phone)
                                            <a href="https://wa.me/{{ $ketua->external_phone }}" target="_blank"
                                            ...
                                            @if($ketua->external_email)
                                            <a href="mailto:{{ $ketua->external_email }}"
                                            ...
                                            @if($ketua->external_phone)
                                            <a href="tel:{{ $ketua->external_phone }}"
                    ...
                    <!-- Sekretaris & Bendahara Section (Di Bawah - Grid 2 Kolom) -->
                    <section class="py-16 bg-white fade-in-up animation-delay-100">
                        <div class="px-4 sm:px-6 lg:px-8 mx-auto max-w-6xl">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                                <!-- Sekretaris -->
                                <div>
                                    <div class="text-center mb-8">
                                        <h2 class="text-3xl font-bold text-[#001F3F] mb-4">Sekretaris</h2>
                                        <p class="text-gray-600">Bertanggung jawab atas administrasi dan sekretariat</p>
                                    </div>
                                    
                                    @if($sekretaris)
                                    <div class="structure-card">
                                        <div class="structure-image-container">
                                            @if($sekretaris->person_photo)
                                            @php
                                            $photoUrl = getStructurePhotoUrl($sekretaris->person_photo);
                                            @endphp

                                            @if($photoUrl)
                                            <img src="{{ $photoUrl }}"
                                                alt="{{ $sekretaris->person_name }}"
                                                class="structure-image"
                                                onerror="this.style.display='none'; this.nextElementSibling.style.display='flex';">
                                            @endif
                                            
                                            <!-- Fallback avatar -->
                                            <div class="structure-avatar" style="{{ ($sekretaris->person_photo && isset($photoUrl)) ? 'display: none;' : '' }}">
                                        ...
                                        <h3 class="structure-name">{{ $sekretaris->person_name }}</h3>
                                        <p class="structure-position">
                                            {{ $sekretaris->position->name ?? 'Sekretaris DPC' }}
                                        </p>

                                        @if($sekretaris->external_phone || $sekretaris->external_email)
                                        <div class="structure-contact">
                                            @if($sekretaris->external_phone)
                                            <a href="https://wa.me/{{ $sekretaris->external_phone }}" target="_blank"
                                                class="contact-btn whatsapp"
                                                title="WhatsApp">
                                                <i class="fab fa-whatsapp"></i>
                                            </a>
                                            ...
                                            @if($sekretaris->external_email)
                                            <a href="mailto:{{ $sekretaris->external_email }}"
                                                class="contact-btn email"
                                                title="Email">
                                                <i class="fas fa-envelope"></i>
                                            </a>
                                            ...
                                            @if($sekretaris->external_phone)
                                            <a href="tel:{{ $sekretaris->external_phone }}"
                                                class="contact-btn phone"
                                                title="Telepon">
                                                <i class="fas fa-phone"></i>
                                            </a>
                                    ...
                                    @else
                                    <div class="structure-card bg-gray-50 border-2 border-dashed border-gray-300">
                                        <div class="structure-avatar bg-gray-200 text-gray-400">
                                            <i class="fas fa-file-alt text-3xl"></i>
                                        </div>
                                        <h3 class="structure-name text-gray-400">Belum Ditentukan</h3>
                                        <p class="structure-position text-gray-500">Sekretaris DPC</p>
                                    </div>
                                    @endif
                                </div>
                                ...
                                <div>
                                    <div class="text-center mb-8">
                                        <h2 class="text-3xl font-bold text-[#001F3F] mb-4">Bendahara</h2>
                                        <p class="text-gray-600">Bertanggung jawab atas keuangan organisasi</p>
                                    </div>
                                    
                                    @if($bendahara)
                                    <div class="structure-card">
                                        <div class="structure-image-container">
                                            @if($bendahara->person_photo)
                                            @php
                                            $photoUrl = getStructurePhotoUrl($bendahara->person_photo);
                                            @endphp

                                            @if($photoUrl)
                                            <img src="{{ $photoUrl }}"
                                                alt="{{ $bendahara->person_name }}"
                                                class="structure-image"
                                                onerror="this.style.display='none'; this.nextElementSibling.style.display='flex';">
                                            @endif
                                            
                                            <!-- Fallback avatar -->
                                            <div class="structure-avatar" style="{{ ($bendahara->person_photo && isset($photoUrl)) ? 'display: none;' : '' }}">
                                        ...
                                        <h3 class="structure-name">{{ $bendahara->person_name }}</h3>
                                        <p class="structure-position">
                                            {{ $bendahara->position->name ?? 'Bendahara DPC' }}
                                        </p>

                                        @if($bendahara->external_phone || $bendahara->external_email)
                                        <div class="structure-contact">
                                            @if($bendahara->external_phone)
                                            <a href="https://wa.me/{{ $bendahara->external_phone }}" target="_blank"
                                                class="contact-btn whatsapp"
                                                title="WhatsApp">
                                                <i class="fab fa-whatsapp"></i>
                                            </a>
                                            ...
                                            @if($bendahara->external_email)
                                            <a href="mailto:{{ $bendahara->external_email }}"
                                                class="contact-btn email"
                                                title="Email">
                                                <i class="fas fa-envelope"></i>
                                            </a>
                                            ...
                                            @if($bendahara->external_phone)
                                            <a href="tel:{{ $bendahara->external_phone }}"
                                                class="contact-btn phone"
                                                title="Telepon">
                                                <i class="fas fa-phone"></i>
                                            </a>
                                    ...
                                    <div class="structure-card bg-gray-50 border-2 border-dashed border-gray-300">
                                        ...
                                        <h3 class="structure-name text-gray-400">Belum Ditentukan</h3>
                                        <p class="structure-position text-gray-500">Bendahara DPC</p>
                                    </div>
                                    @endif
                                </div>
                            </div>
