...
@section('title', 'Tambah DPRT Baru')
...
<div class="space-y-6">
    ...
    <div class="flex justify-between items-center">
        <div>
            <h1 class="text-2xl font-bold text-gray-900">Tambah DPRT Baru</h1>
            <p class="mt-1 text-sm text-gray-600">Tambah data Dewan Pimpinan Ranting (DPRT)</p>
        </div>
        <div>
    ...
    <div class="bg-white rounded-lg shadow overflow-hidden">
        <form action="{{ route('admin.dprt.store') }}" method="POST">
            @csrf
            ...
            <div class="p-6 space-y-6">
                ...
                <div>
                    ...
                    <p class="mt-1 text-sm text-gray-500">Deskripsi singkat tentang DPRT ini.</p>
                    @error('description')
                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div>
                    ...
                    <p class="mt-1 text-sm text-gray-500">Centang untuk mengaktifkan DPRT ini.</p>
                </div>
            </div>
...
@push('scripts')
<script>
// Auto-generate slug from desa name
const desaInput = document.getElementById('desa_name');
const slugInput = document.createElement('input');
slugInput.type = 'hidden';
slugInput.name = 'slug';
slugInput.id = 'slug';
desaInput.parentNode.appendChild(slugInput);

desaInput.addEventListener('blur', function() {
